    ...
    $.getJSON('api/LB/' + appid)
          .done(function (aData) {
              ...
              $.each(data.Servers, function (index, sValue) {
                  ...
                  output += '<div class="panel-heading"><h3><a data-toggle="collapse" onclick="collapseGroup(this)" collapseClass="collapse' + counter + '" href="#collapse' + counter + '">' + appName + '</a></h3></div>';
                  ...
                  $.each(sValue.DC, function (index, dValue) {
                      output += '<div class="col-md-6 panel panel-primary">';
                      ...
                      if (dValue.hasOwnProperty('ProdNodes') && Object.keys(dValue.ProdNodes).length > 0) {
                          if (dValue.hasOwnProperty('StgNodes') && Object.keys(dValue.StgNodes).length > 0) {
                              ...
                              output += '<div class="col-md-6 panel panel-primary single">';
                          }
